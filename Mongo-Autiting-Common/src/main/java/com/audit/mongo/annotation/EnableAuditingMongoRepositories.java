...
import com.audit.mongo.handler.AuditingMongoRepositoriesRegistrar;

@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@Inherited
@Import(AuditingMongoRepositoriesRegistrar.class)
public @interface EnableAuditingMongoRepositories {
    /**
